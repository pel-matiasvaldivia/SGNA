...
MODULES = {
  ...
  "campo": {"name":"Auditorías de Campo (App móvil offline)","clause":"App móvil · PWA","tagline":"Ejecutá auditorías en sitio, incluso sin internet.","description":"Aplicación móvil para que el auditor de campo ejecute los controles asignados por el auditor líder directamente desde el celular. Funciona sin conexión y sincroniza automáticamente al reconectar.","howTo":["El auditor líder o un supervisor asigna la auditoría desde «Auditorías Internas» y define su checklist: automático por norma ISO, o manual con «Editar preguntas del checklist».","Las listas de verificación propias (ej. uso de EPP) se pueden guardar como plantilla y reutilizar en futuras asignaciones.","El auditor abre «Mis Auditorías (Campo)» en el celular y ejecuta cada control: conforme, no conforme o N/A, con foto y ubicación GPS.","Sin conexión, las respuestas se guardan en el dispositivo; al recuperar señal, se sincronizan solas.","Al terminar, el auditor firma digitalmente y se genera el reporte; los «no conforme» abren una No Conformidad automáticamente."],"recommendations":["Instalá la app desde el navegador del celular (se agrega como ícono, sin App Store).","Redactá preguntas cerradas y verificables en sitio (se responden conforme / no conforme / N/A).","Guardá como plantilla los controles que repetís en distintas sedes o cuadrillas.","Sacá la foto de evidencia en cada punto crítico.","Verificá el indicador de sincronización antes de cerrar la jornada."]},
