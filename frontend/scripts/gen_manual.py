...
MODULES = {
  ...
  "campo": {"name":"Auditorías de Campo (App móvil offline)","clause":"App móvil · PWA","tagline":"Ejecutá auditorías en sitio, incluso sin internet.","description":"Aplicación móvil para que el auditor de campo ejecute los controles asignados por el auditor líder directamente desde el celular. Registra evidencia con la cámara y con notas de voz, funciona sin conexión y sincroniza automáticamente al reconectar.","howTo":["El auditor líder o un supervisor asigna la auditoría desde «Auditorías Internas». Puede elegir una norma ISO (checklist automático) o «Sin plantilla» para armar las preguntas a medida.","Las preguntas se cargan con «Editar preguntas del checklist», antes o después de asignar; las listas propias (ej. uso de EPP) se guardan como plantilla y se reutilizan.","Si la auditoría le llegó sin preguntas, el auditor toca «Solicitar checklist al líder» y el pedido llega por correo a los administradores.","El auditor abre «Mis Auditorías» en el celular y ejecuta cada control: conforme, no conforme o N/A, con ubicación GPS automática.","Como evidencia puede sacar la foto con la cámara del teléfono y grabar una nota de voz en lugar de escribir la observación.","Sin conexión, respuestas y evidencias se guardan en el dispositivo; al recuperar señal, se sincronizan solas.","Al terminar, el auditor firma digitalmente: se cierra la auditoría, las notas de voz se transforman en texto y se genera el reporte; los «no conforme» abren una No Conformidad automáticamente."],"recommendations":["Instalá la app desde el navegador del celular (se agrega como ícono, sin App Store).","Redactá preguntas cerradas y verificables en sitio (se responden conforme / no conforme / N/A).","Guardá como plantilla los controles que repetís en distintas sedes o cuadrillas.","Sacá la foto de evidencia en cada punto crítico.","La nota de voz es más rápida que escribir en planta: el texto transcripto queda en el reporte y en la no conformidad.","Verificá el indicador de sincronización antes de cerrar la jornada."]},
